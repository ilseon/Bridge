	...
	<div class="container">
		...
		<div class="col-md-2 col-md-offset-1">
			...
			<br /> <br /> <input type="file" name="uploadimage"
				id="uploadimage" /> <br /> <input type="date" class="form-control"
				id="date" placeholder="날짜">
		</div>
		<br />
		...
		<div class="container">
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<table class="table">
					...
					<tbody>
						<tr>
							<td><input type="file" name="upFile<%=i%>" id="upFile<%=i%>" /></td>
							<td><label style="float: left"> <input type="radio"
									name="title" id="title<%=i%>">
							</label></td>
							<td><input type="text" name="song" id="song<%=i%>" /></td>
							<td><input type="checkbox" id="limit<%=i%>"></td>
						</tr>
						<%
							}
						%>
			...
			<!-- 버튼 start -->
			<div class="col-md-10 col-md-offset-5" style="margin-top: 100px">
				<div class="form-group">
