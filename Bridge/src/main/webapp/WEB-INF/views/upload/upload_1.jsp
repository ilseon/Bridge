			...
			<div class="jumbotron" id="pom">
				...
				<div class="col-md-2 col-md-offset-1">
					<img src='resources/image/upload/album/album_image.PNG'
						width="180px"> <br /> <br /> <input type="file"
						name="uploadimage" id="albumimg" /><br /> <input type="date"
						class="form-control" id="date" style="width: 130%;"><br />
					<!-- 아티스트  정보 입력을 위한 버튼 -->
					<div class="btn-group btn-group-justified" style="width: 130%;">
						<a href="#" class="btn btn-info" onclick="fnResigter()">아티스트</a>
					</div>
				</div>
				<!-- end -->
				...
				<form class="form-horizontal" id="f" method="post" action="upload">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							<!-- 앨범에 대한 설명 입력 -->
							<label for="description" class="col-lg-4 control-label">설명</label>
							<div class="col-lg-8">
