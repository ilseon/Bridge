      ...
      <div class="container" style="margin-bottom: 150px">
         ...
         <div class="col-md-12">
            <form class="form-horizontal" id="album" method="post"
               ...
               <c:forEach var="list" items="${album}" begin="1" end="2">
                  <br />
                  <br />
                  <div class="jumbotron" id="pom">
                     <div id="upload_main">
                        <div class="col-md-2 col-md-offset-1" id="chp">
                           <input type="hidden" id="albumNumber" name="albumNumber"
                              value="${list.albumNumber}" /> <img
                              src="/Bridge/resources/image/upload/album/${list.albumImg}"
                              
                              width="160px" id="album_check"><br /> <br /> <input
                              type="file" name="albumImg" id="albumImg" accept="image/*" />
                           <br />
                        </div>
                        <div class="col-md-4" id="pom2">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td><input type="file" name="musicFile" id="musicFile"
                              accept="audio/*" value="/Bridge/resources/image/upload/artist/${list.musicFile}" />${list.musicFile}<br /></td>
