				...
				<div id="upload_main">
					...
					<div class="col-md-2">
						<img src='resources/image/upload/album/album_image.PNG'
							width="160px"> <br /> <br /> <input type="file"
							name="uploadimage" id="albumimg" /> <br /> <input type="date"
							class="form-control" id="date" style="width: 130%;">
					</div>
					<br />
					...
					<form class="form-horizontal" id="f" method="post">
						<fieldset>
							<div class="col-md-5 col-md-offset-1">
								...
								<div class="form-group">
									<!-- 등록할 음원의 수 입력 -->
									<label for="counter" class="col-lg-3 control-label">곡의
										수</label>
									<div class="col-md-4">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-8">
										<textarea class="form-control" rows="11" cols="70"
					...
					<table class="table">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" name="musicvideo<%=i%>" id="musicvideo<%=i%>"
									class="form-control" /></td>
								<td>&nbsp;&nbsp;&nbsp;
									<button class="btn btn-default btn-xs">
										<span class="glyphicon glyphicon-star-empty" id="limit<%=i%>"></span>
									</button>
								</td>
							</tr>
							<%
