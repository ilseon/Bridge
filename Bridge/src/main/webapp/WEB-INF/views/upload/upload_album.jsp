            ...
            <form id="album" name="album" action="upload2" method="post"
               ...
               <div id="upload_main">
                  <div class="col-md-2 col-md-offset-1">
                     <h5>
                        <strong>< 앨범 이미지 ></strong>
                     </h5>
                     <br /> <input type="file" name="albumImg" id="albumImg"
                        accept="image/*" /><br /> <input type="date"
                        class="form-control" name="albumDate" id="albumDate"
                        style="width: 148%;"><br />
                     <div class="btn btn-primary" id="artistsub">아티스트</div>
                     <br /> <br /><img
                        src="/Bridge/resources/image/upload/artist/${artistList.artistImg}"
                        width="120%"><br/><br/>
                        <input type="text" class="form-control"
                        id="artistName" name="artistName"
                        value="${artistList.artistName}" style="width: 148%;"
                        readonly="readonly">
                        <input
                        type="hidden" id="artistNumber" name="artistNumber"
