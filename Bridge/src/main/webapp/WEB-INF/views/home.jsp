				...
				<table class="table">
					<c:forEach begin="0" end="9" var="music" items="${musicList}" step="1">
						...
						<td width="10"><a href="/test"><img src="<%=request.getAttribute("realpath")%><c:out value="${music.albumImg}"/>" style="height:60px; width:60px;"/></a></td>
                         ...
                         <td width="5%"><button class="btn btn-default btn-xs" id="playlist"><span class="glyphicon glyphicon-plus" style="color:green" onclick="player(${music.musicNumber})"></span></button></td>
						</tr>
					</c:forEach>
				</table>
				<!-- 인기차트 테이블 끝 -->
