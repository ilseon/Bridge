			...
			<div class="col-sm-11"
				...
				<c:forEach var="i" begin="0" end="11" step="1">
					<div class="col-xs-6 col-sm-1" style="margin: 35px;">
						<a href="test"> <img src="/resources/image/shinhwa.PNG"
							style="height: 80px;">
							<div>WE (12번째..)</div>
							<div>신화</div>
						</a>
				...
				<table class="table">
					<c:forEach begin="1" end="10" var="j">
						<tr style="height: 70px;" >
							...
							<td width="20%">표적</td>
							<td width="7%">신화</td>
							<td width="10%"><button class="btn btn-default btn-xs"><span class="glyphicon glyphicon-play" style="color:red" ></span></button></td>
							<td width="10%"><button class="btn btn-default btn-xs"><span class="glyphicon glyphicon-plus" style="color:green"></span></button></td>
						</tr>
					</c:forEach>
				</table>
				<!-- 인기차트 테이블 끝 -->
