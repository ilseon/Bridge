...
$(function(){
   ...
   $("#check_all .btn").click(function(){
      ...
      if(this_name=="listen"||$(this).attr('id')=="all_listen"||$(this).attr('id')=="add_listen"){
     	 window.open("playerAll?playlistAll="+playAll,"new","width=500, height=900, resizable=no, scrollbars=no, status=no, location=no, directories=no;");
      }else if(user!=""){
         var list=$("#mytable input[type=checkbox]");
            for(var i = 0 ; i<list.length; i++){
               if(list[i].checked==true){
