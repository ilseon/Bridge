                ...
                <tbody> 
                  ...
                  <c:set var="rank" value="${rank+1}"/>
                      <tr>
                         ...
                         <td width="7%">${rank} &nbsp;<a href="album_detail?albumNumber=${music.albumNumber}">
                         	<img src="/Bridge/resources/image/upload/album/${music.albumImg}" style="height:60px; width:60px;"/></a>
                         </td>
                         ...
                         <td width="7%">
                         	...
                         	<span class="glyphicon glyphicon-play" style="color:red" onclick="player(${music.musicNumber})"></span>
                         	</button>
                         </td>
                         <td width="7%">
                         	<button class="btn btn-default btn-xs" id="playlist" onclick="player(${music.musicNumber})">
                         	<span class="glyphicon glyphicon-plus" style="color:green"></span></button>
                         </td>
                         <td width="7%">
                         	<a href="myalbum_modal?musicnumber=${music.musicNumber}" class="btn btn-default btn-xs" data-toggle="modal" data-target="#MyAlbum" id="myalbum">
                         	<span class="glyphicon glyphicon-paste"></span></button></a>
                         </td>
                         <td width="7%">
                         	<a href="download_modal?musicnumber=${music.musicNumber}" class="btn btn-default btn-xs" data-toggle="modal" data-target="#Download" id="download">
                         	<span class="glyphicon glyphicon-download-alt"></span></a>
                         </td>
                         <td width="7%">
                         <c:if test="${music.musicVideo ne null}">
                         <a onClick="window.open('iframe?video=${music.musicVideo}','MusicVideo','width=596,height=345,top=100,left=700');return false">
                         	<button class="btn btn-default btn-xs"><span class="glyphicon glyphicon-play-circle"></span></button>
                         </a></c:if>
                         <c:if test="${music.musicVideo eq null}"><button class="btn btn-default btn-xs"><span class="glyphicon glyphicon-play-circle"></span></button></c:if>
                         </td>
                         <td width="7%">
