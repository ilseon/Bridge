                ...
                <tbody> 
                   <c:set var="j" value="0"></c:set>
					...
					<tr>
						...
						<td><button class="btn btn-default btn-xs" onclick="player(${list.musicNumber})">
						...
						<td><a onClick="window.open('iframe?video=${list.musicVideo}','MusicVideo','width=596,height=345,top=100,left=700');return false">
