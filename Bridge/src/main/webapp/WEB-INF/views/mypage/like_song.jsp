	 ...
	 <div class="col-sm-8" style="margin-bottom: 150px">
        ...
        <div class="table-responsive">   
            ...
            <div id="check_all">
					...
					<button class="btn btn-default btn-md" data-toggle="modal" id="delete" name="like">
						...
						<tr>
							...
							<td width="7%"><button class="btn btn-default btn-xs">
									<span class="glyphicon glyphicon-play" style="color: red"
										onclick="player(${list.musicNumber})"></span>
								</button></td>
							...
							<td width="7%"><button class="btn btn-default btn-xs">
									<a onClick="window.open('iframe?video=${list.musicVideo}','MusicVideo','width=596,height=345,top=100,left=700');return false">
