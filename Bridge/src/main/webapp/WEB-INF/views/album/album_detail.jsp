...
<script>
	...
	<div class="container"> <!-- 첫 번째 블럭(사진, 앨범 소개) start -->	
		<div class="col-md-5">
			<img src="/Bridge/resources/image/upload/album/${albumVO.albumImg}" width="60%">
		</div>
	...
	<div class="container"><!-- 두 번째 블럭(수록곡) start -->
		...
		<table class="table" id="mytable">
			...
			<c:forEach var="musicVO" items="${musicList}" >				
				<tr>
					<td width="3%"><input type="checkbox" value="${musicVO.musicNumber}" value="${musicVO.musicNumber}"/></td>
					<td>${cnt}</td>
					<td>${musicVO.musicSubject} &nbsp; <c:if test="${musicVO.musicTitle == 1}"><img src="/Bridge/resources/images/musicTitle.png" width="15%"/></c:if></td>
